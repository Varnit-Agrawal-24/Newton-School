...
Your task is to find the number of positions in the chessboard knight 
can jump into in a single move .
...
You just have to complete the function Knight() that takes 
integers X and Y as arguments.

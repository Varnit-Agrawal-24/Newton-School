...
If the typecasting is done successfully then we will print "Nice Job" 
otherwise "Wrong answer".

Input =>
User task:
Since this is a functional problem you don't have to worry about the input.
You just have to complete the function checkConvertion(),
which contains N as a parameter.
